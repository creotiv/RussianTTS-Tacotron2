...
import torch
from vae import kl_anneal_function
...
class Tacotron2Loss(nn.Module):
    ...
    def forward(self, model_output, targets):
        _, mel_out, mel_out_postnet, gate_out, alignments_out, tpse_gst_pred,gst_target,vae = model_output
        ...
        vae_loss_weight = torch.tensor(0)
        if vae:
            # https://qr.ae/pGGj9U
            ...
            emb_loss = kl_loss * vae_loss_weight
        ...
        return (mel_loss, gate_loss, loss_atten, emb_loss),(kl_loss, vae_loss_weight)
